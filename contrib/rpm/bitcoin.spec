...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7571
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7582
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7581
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 7571
	%{_sbindir}/semanage port -d -p tcp 7582
	%{_sbindir}/semanage port -d -p tcp 7581
	for selinuxvariant in %{selinux_variants}; do
